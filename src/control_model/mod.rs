...
mod tests {
    ...
    fn test_bip110_pushdata_validation() {
        ...
        assert!(matches!(
            result.violations[0],
            Bip110Violation::PushdataExceedsLimit { size: 257, max: 256 }
        ));
    }
    ...
    fn test_bip110_witness_element_validation() {
        ...
        assert!(matches!(
            result.violations[0],
            Bip110Violation::WitnessElementExceedsLimit { size: 257, max: 256 }
        ));
    }
    ...
    fn test_bip110_violation_display() {
        let violation = Bip110Violation::PushdataExceedsLimit { size: 300, max: 256 };
