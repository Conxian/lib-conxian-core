...
//! - `sdk`: **Comprehensive SDK re-exports** — all 68 accessible conxius-enclave-sdk modules organized by category (Session 52)
//!
//! ## SDK Features (Session 52 — Full Alignment)
//!
//! Enable the `full-sdk` feature for access to all 68 accessible SDK modules:
//!
//! ```toml
...
// ── SDK re-exports (Session 52: all 68 accessible modules) ──
#[cfg(any(
    feature = "enclave",
