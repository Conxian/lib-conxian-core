...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **MuSig2 Aggregation (G-10)** | 40 | 30 | 30 | **100** | **Resolved — real k256 scalar arithmetic** |
| **DLC Primitives (G-06)** | 35 | 25 | 30 | **90** | **In Progress (stub)** |
...
| **FROST Threshold Sig (G-14)** | 35 | 25 | 30 | **90** | **Implemented (RFC 9591 via frost-secp256k1-tr)** |
...
| **Hardware Attestation (G-17)**| 35 | 20 | 30 | **85** | **In Progress (X.509 DER parsing)** |
...
9. **FROST Round 2**: Real trusted dealer keygen + signing cycle implemented via frost-secp256k1-tr (RFC 9591); encrypted share distribution scaffolding in progress (CON-1329).
10. **Hardware Attestation**: X.509 DER parsing for enclave certificate chains (CON-1329).
11. **Fedimint**: Transitioning to real cryptographic blinding via `fedimint-client-wasm` (G-16).

## Current Focus: v2.0.4 Hardening Cycle (2026-06-28)
FROST threshold signing, MuSig2 aggregation, Hardware Attestation, and FROST Round 2 encrypted share distribution.
