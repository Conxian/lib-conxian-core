...
> `lib-conxian-core` APIs provide production verification. The current
> fail-closed boundaries are authoritative; see [`VERIFIER_INVENTORY.md`](VERIFIER_INVENTORY.md).
