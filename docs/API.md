# lib-conxian-core API Reference v0.3.3
...
Core package `lib-conxian-core` `0.3.3`, Rust `1.98.1`, the default feature set
(`default = []`),
...
`conxius-enclave-sdk` `2.0.17` declaration; this Core-only fixture layer deliberately does
