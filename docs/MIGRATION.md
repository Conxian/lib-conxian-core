# Migration Guide: lib-conxian-core v0.2.x → v0.3.3

> **Current release:** `lib-conxian-core` v0.3.3 is the intentional breaking
...
```toml
[dependencies]
lib-conxian-core = { version = "0.3.3", features = ["enclave"] }
```
